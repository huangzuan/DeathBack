package com.huangzuan.deathback.network;
...
@EventBusSubscriber
public class DeathBackModVariables {
	public static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.ATTACHMENT_TYPES, DeathBackMod.MODID);
	...
	public static void init(FMLCommonSetupEvent event) {
		DeathBackMod.addNetworkMessage(PlayerVariablesSyncMessage.TYPE, PlayerVariablesSyncMessage.STREAM_CODEC, PlayerVariablesSyncMessage::handleData);
	}
	...
	public static class PlayerVariables implements INBTSerializable<CompoundTag> {
		...
		public String deathDimension = "\"minecraft:overworld\"";
	...
	public record PlayerVariablesSyncMessage(PlayerVariables data) implements CustomPacketPayload {
		public static final Type<PlayerVariablesSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(DeathBackMod.MODID, "player_variables_sync"));
